...
const  QuestionMcq = () => {
  ...
  return (
    <div className="flex-row grid grid-cols-[1fr_0.7fr_1fr] grid-rows-[0.2fr_1fr_0.4fr_0.4fr_0.5fr_1fr_1fr_1fr] md:grid-cols-[1fr_0.7fr_1fr_1fr] md:grid-rows-[0.2fr_0.3fr_0.4fr_1.3fr_0.5fr_0.3fr] gap-x-[20px] gap-y-[10px] w-[95vw] h-[85vh] mx-6 mt-10">
    ...
    <div className="[grid-area:2_/_1_/_4_/_4] text-xl pt-2 pl-4 md:[grid-area:2_/_1_/_5_/_4] bg-[#0B121B] text-white border-2 border-[#00B0B0] text-center rounded-lg mr-20 overflow-auto" style={{ height: "100%", alignSelf: "flex-start" }}>      
        <p>{question}</p>
        {/* <p>text</p> */}
    </div>
    {
  attempts === 2 ? (
    // [grid-area:5_/_1_/_6_/_2]
    <div className="[grid-area:3_/_1_/_4_/_4] md:[grid-area:5_/_1_/_6_/_2] content-around text-center mr-20 mt-1">
      <input
        type="number"
        id="response 1"
    ...
    <div className="[grid-area:3_/_1_/_4_/_4] md:[grid-area:5_/_1_/_6_/_2] content-around text-center mr-20 mt-1">
      ...
      <div className="[grid-area:4_/_1_/_5_/_4] md:[grid-area:5_/_3_/_6_/_4] content-around text-center mr-20 mt-1">
        <input
          type="number"
          id="response 2"
      ...
      {/* </div> */}
      <div className=" bg-[#0B121B] grid grid-cols-[2fr_1fr_1fr_1fr] md:[grid-area:2_/_4_/_4_/_5] [grid-area:6_/_1_/_7_/_4] border-2 border-[#00B0B0] grid-rows-[1fr_1fr] gap-x-[2px] gap-y-[2px] rounded-lg p-0.5 divide-y-2 divide-solid">
      ...
      <div className="[grid-area:5_/_1_/_6_/_4] md:[grid-area:6_/_1_/_7_/_4] w-0 mb-10 flex ml-auto mr-auto">
        <button
          type="submit"
      ...
      {/* <div className="top-0 mt-20"> */}
          <div className="[grid-area:7_/_1_/_8_/_4] md:[grid-area:4_/_4_/_7_/_5] ">
