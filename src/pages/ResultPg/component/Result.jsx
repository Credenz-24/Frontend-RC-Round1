        ...
        <div className="container flex flex-wrap items-center justify-center h-[100%] w-full gap-16">
          ...
          <div className="rightbox  flex flex-col w-[110vh] h-[80vh] rounded-[30px] backdrop-blur-[20px] border-2 border-[#0addd7] justify-center items-start z-[100]">
            <div className="jellyfish  z-5 h-[60%] w-[100%] rounded-[30px]  bg-transparent flex justify-around items-center ">
              <div className="photol flex flex-col h-[30vh] w-[35vh]  bg-[#11BFAE] rounded-[30px] justify-end p-4 items-center gap-[5px] z-[-1]">
                <img
                  src="../score.png"
                  alt=""
                ...
                <div className="in flex flex-col h-[10vh] w-[30vh] rounded-[15px] bg-[#054656]  justify-center items-center">
              ...
              <div className="out flex flex-col  h-[30vh] w-[35vh] rounded-[30px] bg-[#11BFAE] justify-end p-4 items-center gap-[10px] z-[-1]">
              ...
              <div className="flex flex-col h-full w-[40%] justify-center items-center gap-2 ">
                <div className="circle flex flex-row justify-around item-center  gap-10">
                  <div style={{ width: 155, height: 155 }}>
                    <CircularProgressbar value={acc} text={`${acc}%`} strokeWidth={12}  
                    styles={buildStyles({
                        pathColor: `#2FDDD0`,
                        textColor: '#fff',
                        trailColor: '#013542',
